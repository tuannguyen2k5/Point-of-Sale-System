...
@section('title','Create a new Biller')
@section('content')
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Biller Add</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-primary">
                ...
                <div class="card-body">
                    <form method="post" action="{{route('admin.billers.create.store')}}">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <input type="submit" value="Create New biller" class="btn btn-success float-right">
                            </div>
                        </div>
                    </form>
                </div>
