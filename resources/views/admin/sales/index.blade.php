    ...
    <div class="container-fluid">
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Sale Manage</li>
                </ol>
            </div>
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
            <div class="btn-group me-2">
                <a class="btn btn-danger" href="{{route('admin.sales.create')}}">Create a new Sale</a>
            </div>
        </div>
    </div><!-- /.container-fluid -->
</section>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="sale-actions text-right">
                                        ...
                                        <a class="delete btn btn-danger btn-sm" href="#" data="{{$sale->id}}">
        ...
        <div class="modal-content">
            <form action="{{route('admin.sales.delete')}}" method="post">
                ...
                <div class="modal-body">
                    Are you want to delete this sale?
                </div>
