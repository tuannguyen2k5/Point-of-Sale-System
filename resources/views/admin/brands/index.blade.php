    ...
    <div class="container-fluid">
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
            <div class="btn-group me-2">
                <a class="btn btn-danger" href="{{route('admin.brands.create')}}">Create a new brand</a>
            </div>
        </div>
    </div><!-- /.container-fluid -->
</section>
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="branch-actions text-right">
                                        <a class="btn btn-primary btn-sm" href="{{route('admin.brands.view',$brand->id)}}">
                                        ...
                                        <a class="delete btn btn-danger btn-sm" href="#" data="{{$brand->id}}">
