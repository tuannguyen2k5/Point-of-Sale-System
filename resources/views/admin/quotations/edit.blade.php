        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Quotation Edit</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
...
<section class="content">
    <div class="row">
        <div class="col-md-12">
            <div class="card card-primary">
                ...
                <div class="card-body">
                    <form method="post" action="{{route('admin.quotations.edit.update',$quotation->id)}}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                <input type="text" id="month" name="month"
                                    ...
                                    data-target="#reservationdate" value="{{old('month', $quotation->month ?? '')}}">
    ...
    <div class="row">
        <div class="col-12">
            ...
            <input type="submit" value="Edit Quotation" class="btn btn-success float-right">
        </div>
    </div>
    </form>
</section>
