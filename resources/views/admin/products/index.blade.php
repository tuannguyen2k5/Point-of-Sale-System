    ...
    <div class="container-fluid">
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
            <div class="btn-group me-2">
                <a class="btn btn-danger" href="{{route('admin.products.create')}}">Create a new product</a>
            </div>
        </div>
    </div><!-- /.container-fluid -->
</section>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Product DataTable with default features</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="product-actions text-right">
                                        ...
                                        <a class="delete btn btn-danger btn-sm" href="#" data="{{$product->id}}">
