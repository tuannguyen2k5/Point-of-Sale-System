    ...
    <div class="container-fluid">
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
            <div class="btn-group me-2">
                <a class="btn btn-danger" href="{{route('admin.customers.create')}}">Create a new customer</a>
            </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Customer DataTable with default features</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="customer-actions text-right">
                                        ...
                                        <a class="delete btn btn-danger btn-sm" href="#" data="{{$customer->id}}">
...
<div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{route('admin.customers.delete')}}" method="post">
                @csrf
                @method('DELETE')
...
<script type="text/javascript">
    $('.delete').click(function() {
        $('#customer_id').val($(this).attr('data'))
