    ...
    <div class="container-fluid">
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
            <div class="btn-group me-2">
                <a class="btn btn-danger" href="{{route('admin.purchases.create')}}">Create a new Purchase</a>
            </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Purchase DataTable with default features</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="purchase-actions text-right">
                                        ...
                                        <a class="delete btn btn-danger btn-sm" href="#" data="{{$purchase->id}}">
...
<div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{route('admin.purchases.delete')}}" method="post">
                @csrf
                @method('DELETE')
...
<div class="modal fade" id="importModal" tabindex="-1" aria-labelledby="importModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="post" enctype="multipart/form-data" action="{{route('admin.purchases.import')}}">
                @csrf
                <div class="modal-header">
...
<script type="text/javascript">
    $('.delete').click(function() {
        $('#purchase_id').val($(this).attr('data'))
