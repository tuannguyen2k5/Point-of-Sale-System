...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Edit Purchase Payment #{{$purchase_payment->id}}</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                    <li class="breadcrumb-item active">Edit Purchase Payment</li>
                </ol>
            </div>
        </div>
        ...
        <div class="col-md-12">
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">Purchase Payment #{{$purchase_payment->id}}</h3>
                </div>
                <div class="card-body">
                    <form method="post" action="{{route('admin.purchase-payments.edit.update',$purchase_payment->id)}}"
                                ...
                                <div class="form-group" id="payment-type">
                                    ...
                                    <select id="payment_type_id" name="payment_type_id" class="form-control select2">
                                        ...
                                        <option value="{{$type->id}}" @if ($type->id ==
                                            $purchase_payment->payment_type_id)
                                            selected
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="hidden" name="old_validate_photo"
                                            value="{{$purchase_payment->validate_photo}}">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <a href="{{route('admin.purchases.view', $purchase_payment->purchase_id)}}"
                                    class="btn btn-primary">View Purchase</a>
                                <input type="submit" value="Edit Purchase Payment" class="btn btn-success float-right">
                            </div>
                        </div>
                    </form>
                </div>
